...
var Query = {
  ...
  getRegStatusApplicants: function () {
    ...
    regeneratorRuntime.mark(function _callee2(parent, _ref6, ctx) {
      var education, universityId, majorId, regStatusfeeSettings, fee, year, trades, userId, userExams, userExamProvinceId, userExamSubject, regStatuses, applicants;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              regStatusfeeSettings = _context2.sent;
  ...
  getRegStatusApplicantsById: function () {
    ...
    regeneratorRuntime.mark(function _callee3(parent, _ref7, ctx) {
      var regStatusId, regStatusfeeSettings, fee, year, trades, userId, userExams, userExamProvinceId, userExamSubject, applicants;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              regStatusId = _ref7.regStatusId;
              (0, _validate.checkId)(regStatusId); // 判断是否为付费会员
            ...
            case 4:
              regStatusfeeSettings = _context3.sent;
  ...
  kefu: function kefu(parent, args, ctx) {
    return ctx.db.user({
      username: "kefu"
    });
  }
