...
var Query = {
  ...
  oldColleagues: function () {
    ...
    regeneratorRuntime.mark(function _callee8(parent, _ref13, ctx) {
      ...
      }, _callee8, null, [[18, 31, 35, 43], [36,, 38, 42]]);
    }));
      ...
      return regeneratorRuntime.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              return _context17.abrupt("return", ctx.db.products());
        ...
        while (1) {
          switch (_context19.prev = _context19.next) {
            ...
            case 22:
              ...
              return _context19.abrupt("return", loveMatches[0]);
      ...
      return regeneratorRuntime.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            ...
            case 11:
              return _context20.abrupt("return", ctx.db.skills({
                where: {
                  name_contains: name
                },
                first: 10
      ...
      return regeneratorRuntime.wrap(function _callee21$(_context21) {
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 10:
              projects = _context21.sent;
              return _context21.abrupt("return", projects);
      ...
      return regeneratorRuntime.wrap(function _callee22$(_context22) {
        while (1) {
          switch (_context22.prev = _context22.next) {
            ...
            case 9:
              return _context22.abrupt("return", ctx.db.partnerConditions({
                where: {
                  project: {
                    id: projectId
                  }
